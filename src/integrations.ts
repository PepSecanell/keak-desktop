...
export const AI_TOOLS: ToolDef[] = [
  ...
  { id: "make", name: "Make", category: "Automation", auth: "token",
    keyLabel: "Make API token", getUrl: "https://www.make.com",
    hint: "Paste your Make API token and pick your region, then load your scenarios and choose which one Keak runs (2,000+ apps).", icon: "", brand: "#6D00CC" },
  ...
  { id: "stripe", name: "Stripe", category: "Payments", auth: "apikey",
    keyLabel: "Stripe secret key (sk_live_… or sk_test_…)", getUrl: "https://dashboard.stripe.com/apikeys",
    hint: "Read payments, customers and subscriptions, and create payment links.", icon: "stripe", brand: "#635BFF" },
  { id: "clickup", name: "ClickUp", category: "Productivity", auth: "token",
    keyLabel: "ClickUp personal API token (pk_…)", getUrl: "https://app.clickup.com/settings/apps",
    hint: "Create and update tasks, lists and docs across your ClickUp workspace.", icon: "clickup", brand: "#7B68EE" },
